          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1 bg-slate-100 p-0.5 rounded-lg border border-slate-200">
              <button
                ...
                className={`px-2 py-0.5 font-bold rounded transition uppercase text-[8px] tracking-wider ${viewMode === 'list' ? 'bg-white text-slate-900 shadow-sm border border-slate-200' : 'text-slate-500 hover:text-slate-700'
                  }`}
              >
                List
              </button>
              <button
                ...
                className={`px-2 py-0.5 font-bold rounded transition uppercase text-[8px] tracking-wider ${viewMode === 'grid' ? 'bg-white text-slate-900 shadow-sm border border-slate-200' : 'text-slate-500 hover:text-slate-700'
                  }`}
              >
                Grid
              </button>
          ...
          <div className="w-64 border-r border-[#EAE5DB] bg-[#FAF8F5] p-5 flex flex-col gap-6 font-sans shrink-0 h-full overflow-y-auto">
            ...
            <div className="flex flex-col gap-1.5">
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold tracking-wider transition flex items-center gap-2.5 ${activeTab === 'add-product' ? 'bg-primary text-slate-900 shadow-sm' : 'text-slate-650 hover:bg-white hover:text-slate-800'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold tracking-wider transition flex items-center gap-2.5 ${activeTab === 'single-scents' ? 'bg-primary text-slate-900 shadow-sm' : 'text-slate-650 hover:bg-white hover:text-slate-800'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold tracking-wider transition flex items-center gap-2.5 ${activeTab === 'scent-combos' ? 'bg-primary text-slate-900 shadow-sm' : 'text-slate-650 hover:bg-white hover:text-slate-800'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold tracking-wider transition flex items-center gap-2.5 ${activeTab === 'orders' ? 'bg-primary text-slate-900 shadow-sm' : 'text-slate-650 hover:bg-white hover:text-slate-800'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold tracking-wider transition flex items-center gap-2.5 ${activeTab === 'coupons' ? 'bg-primary text-slate-900 shadow-sm' : 'text-slate-650 hover:bg-white hover:text-slate-800'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold tracking-wider transition flex items-center gap-2.5 ${activeTab === 'settings' ? 'bg-primary text-slate-900 shadow-sm' : 'text-slate-650 hover:bg-white hover:text-slate-800'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold tracking-wider transition flex items-center gap-2.5 ${activeTab === 'affiliates' ? 'bg-primary text-slate-900 shadow-sm' : 'text-slate-650 hover:bg-white hover:text-slate-800'
                  }`}
              >
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-lg text-xs font-bold tracking-wider transition flex items-center gap-2.5 ${activeTab === 'admins' ? 'bg-primary text-slate-900 shadow-sm' : 'text-slate-650 hover:bg-white hover:text-slate-800'
                  }`}
              >
                        ...
                        <div>
                          ...
                          <div className="flex gap-2 bg-slate-100 p-1 rounded-lg">
                            <button
                              ...
                              className={`flex-1 py-1.5 text-[10px] font-bold tracking-wider rounded-md transition uppercase ${productType === 'single' ? 'bg-white text-slate-900 shadow-sm border border-[#EAE5DB]' : 'text-slate-500'
                                }`}
                            >
                              Single Scent
                            </button>
                            <button
                              ...
                              className={`flex-1 py-1.5 text-[10px] font-bold tracking-wider rounded-md transition uppercase ${productType === 'combo' ? 'bg-white text-slate-900 shadow-sm border border-[#EAE5DB]' : 'text-slate-500'
                                }`}
                            >
                              Pre-made Combo
                            </button>
                        ...
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {(['all', 'pending', 'shipped', 'delivered', 'cancelled'] as const).map((status) => (
                            <button
                              ...
                              className={`px-3 py-1.5 rounded-lg text-[9px] font-bold font-mono tracking-wider transition ${orderStatusFilter === status
                                ...
                                <tr key={order._id} className="border-b border-slate-150 hover:bg-slate-50 transition text-slate-700">
                                  ...
                                  <td className="py-4 text-center align-top pr-2">
                                    <button
                                      ...
                                      className={`px-2 py-0.5 text-[9px] font-bold tracking-wider rounded font-mono border transition ${order.paymentStatus === 'success'
